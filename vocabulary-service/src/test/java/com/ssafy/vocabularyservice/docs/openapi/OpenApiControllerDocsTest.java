package com.ssafy.vocabularyservice.docs.openapi;

import com.ssafy.vocabularyservice.api.controller.openapi.OpenApiController;
import com.ssafy.vocabularyservice.api.controller.openapi.response.WordResponse;
import com.ssafy.vocabularyservice.api.service.openapi.OpenApiService;
...
public class OpenApiControllerDocsTest extends RestDocsSupport {
    ...
    void searchDictionary() throws Exception {
        ...
        mockMvc.perform(
            get("/vocabulary-service/openapi/search")
                .param("query", "나무")
        )
            .andDo(print())
