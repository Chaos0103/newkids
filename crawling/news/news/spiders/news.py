...
class NewsCrawlerSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        for website in websites:
            ...
            # 동아일보 2202페이지까지 있음(9/19기준)
                ...
                donga_categorys = ["01", "02", "03"] # category: 오늘의 시사, 사이언스, 아트&히스토리
    ...
    def joong_crawl_parse(self,response):
        ...
        for i in range(1, 11):
            try:
                url = response.xpath(f'//*[@id="list_mypost"]/table/tbody/tr[{i}]/td[1]/a/span/img/@src')[0].extract()
    ...
    def donga_crawl_parse(self,response):
        ...
        for i in range(1, 11):
            try:
                url = response.xpath(f'/html/body/div[2]/div[2]/div[1]/div[4]/ul/li[{i}]/a/img/@src')[0].extract()
